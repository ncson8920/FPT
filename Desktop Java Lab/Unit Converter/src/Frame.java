...
public class Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbbFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mile", "Meter" }));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("To:");

        cbbTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mile", "Meter" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tfFrom)
                            .addComponent(cbbFrom, 0, 75, Short.MAX_VALUE))
                        .addGap(85, 85, 85)
                        .addComponent(jLabel2)
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tfTo)
                            .addComponent(cbbTo, 0, 75, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(142, 142, 142)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            from = Double.parseDouble(tfFrom.getText());
            if (from<0) {
        ...
        if(cbbFrom.getSelectedIndex()==cbbTo.getSelectedIndex()){
            tfTo.setText(String.valueOf(from));
        }else if(cbbFrom.getSelectedIndex()==1&&cbbTo.getSelectedIndex()==0){
            to = from*0.621368875;
            tfTo.setText(String.valueOf(to));
        }else if(cbbFrom.getSelectedIndex()==0&&cbbTo.getSelectedIndex()==1){
            to = from/0.621368875;
            tfTo.setText(String.valueOf(to));
        }
