...
public class Lab72 {
    ...
    private static String checkInputDate() throws ParseException {
        while (true) {
            try {
    ...
    private static void addAccount(ArrayList<Account> la) throws ParseException {
